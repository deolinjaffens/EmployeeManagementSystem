...
public interface SkillDao {
    ...
    /**
     * <p>
     * Adds new skill in the database
     * </p>
     *
    ...
    Skill getSkillById(int id) throws EmployeeException;
     ...
     * @throws EmployeeException - Exception thrown when there is an issue in
     *                           updating specific details of a skill
     */
     ...
     *                           to a specific employee and connecting with the database
     */
     ...
     *                           skill from the employee and connecting with the database
     */
